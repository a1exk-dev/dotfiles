...
ACTIVE_COLOR=${WAYBAR_PRIVACY_ACTIVE_COLOR:-#e67e80}
INACTIVE_COLOR=${WAYBAR_PRIVACY_INACTIVE_COLOR:-#7a8478}
UNAVAILABLE_COLOR=${WAYBAR_PRIVACY_UNAVAILABLE_COLOR:-#e69875}
...
normalize_colors() {
	[[ $ACTIVE_COLOR =~ ^#[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$ ]] || ACTIVE_COLOR=#e67e80
	[[ $INACTIVE_COLOR =~ ^#[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$ ]] || INACTIVE_COLOR=#7a8478
	[[ $UNAVAILABLE_COLOR =~ ^#[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$ ]] || UNAVAILABLE_COLOR=#e69875
}
