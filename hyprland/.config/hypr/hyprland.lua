...
hl.bind("Print", hl.dsp.exec_cmd("hyprshot -m region --raw | satty --filename - --copy-command wl-copy"), { locked = true })
hl.bind(
	"SHIFT + Print",
	hl.dsp.exec_cmd("hyprshot -m output -m active --raw | satty --filename - --copy-command wl-copy"),
	{ locked = true }
)
